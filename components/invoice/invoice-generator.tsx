...
//                 updateInvoiceDetails({ ...invoiceData.invoiceDetails, currency })
//               }
//             >
...
//           <Button type="button" variant="outline" className="text-green-600 w-full sm:w-auto"  onClick={invoiceId ? updateInvoice : saveInvoice}>
